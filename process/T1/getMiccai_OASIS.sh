...
for j in $bb; do
    ...
    echo ${SNGL} run --cleanenv  -B /data:/home/ebutler/data ${SIMG} -c /home/ebutler${TEMP_COHORT} -d /home/ebutler${DESIGN} -o /home/ebutler${OUTPUT} -r /home/ebutler/data/jux/BBL/studies/nasa_antartica/rawData/ > /home/ebutler/xcpGetMiccaiSubjScripts_OASIS_ANTs3/${name}_${j}.sh

    #qsub /home/ebutler/xcpGetMiccaiSubjScripts_OASIS_ANTs3/${name}_${j}.sh
