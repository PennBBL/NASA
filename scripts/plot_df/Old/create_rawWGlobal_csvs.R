...
# Read in the data
if (type == "gmd") {
	nasa_data <- read.csv("/home/ebutler/erb_data/nasa/nasa_slowjlf_OldAnts_gmd.csv", header=TRUE)
	nasa_vol <- read.csv("/home/ebutler/erb_data/nasa/nasa_slowjlf_OldAnts_vol.csv", header=TRUE)
} else if (type == "vol") {
	nasa_data <- read.csv("/home/ebutler/erb_data/nasa/nasa_slowjlf_OldAnts_vol.csv", header=TRUE)
} 
...
if (type == "gmd") {
	write.csv(nasa_data, file= "/home/ebutler/erb_data/nasa/nasa_raw_brain_OldAnts_gmd.csv", row.names=FALSE)
} else if (type == "vol") {
	write.csv(nasa_data, file= "/home/ebutler/erb_data/nasa/nasa_raw_brain_OldAnts_vol.csv", row.names=FALSE)
}
